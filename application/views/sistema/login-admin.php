...
<head>
    ...
    <title>Steel4Web - Administrador</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <p class="text-center">
                    <br><br>
                    <img src="<?=base_url('assets/img/logo-Steel4web-600.png');?>" alt="Stell4Web" width="300">
                </p>
            </div>
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Steel4Web - Administrador</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="<?=base_url('login/acessarAdmin');?>" method="post">
                            <fieldset>
